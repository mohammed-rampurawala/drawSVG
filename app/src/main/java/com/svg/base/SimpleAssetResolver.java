...
/**
 * A sample implementation of {@link SVGExternalFileResolver} that retrieves
 * files from an application's "assets" folder.
 */
...
public class SimpleAssetResolver extends SVGExternalFileResolver {
	...
	/**
	 * Attempt to find the specified font in the "assets" folder and return a
	 * Typeface object. For the font name "Foo", first the file "Foo.ttf" will
	 * be tried and if that fails, "Foo.otf".
	 */
	@Override
	public Typeface resolveFont(String fontFamily, int fontWeight,
			String fontStyle) {
		Log.i(TAG, "resolveFont(" + fontFamily + "," + fontWeight + ","
				+ fontStyle + ")");
	...
	/**
	 * Attempt to find the specified image file in the "assets" folder and
