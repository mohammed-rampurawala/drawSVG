 ...
 * 
 * We use our own parser to gain a bit of speed. This routine is around twice as
 * fast as the system one.
 * 
...
public class IntegerParser {
	...
	/*
	 * Scan the string for an SVG integer. Assumes maxPos will not be greater
	 * than input.length().
	 */
	...
	/*
	 * Scan the string for an SVG hex integer. Assumes maxPos will not be
